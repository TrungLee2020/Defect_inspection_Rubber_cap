...
class AutoEncoder:
    def __init__(
        ...
        self.start_lr = configCAE.START_LR
        self.lr_max_epochs = configCAE.LR_MAX_EPOCHS
        self.lrf_decrease_factor = configCAE.LRF_DECREASE_FACTOR

        # Training parameters
        self.early_stopping = configCAE.EARLY_STOPPING
        self.reduce_on_plateau = configCAE.REDUCE_ON_PLATEAU
