...
from keras.layers import Input, Dense, Conv2D, Conv2DTranspose, BatchNormalization, LeakyReLU, Flatten, Reshape, Add
...
def build_model(color_mode):
    ...
    y = Conv2DTranspose(img_dim[2], (3, 3), activation="sigmoid", padding="same", strides=(2, 2))(y)
