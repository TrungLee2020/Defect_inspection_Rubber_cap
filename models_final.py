...
class SegmentNet(nn.Module):
    def __int__(self, in_channels=1, init_weights=True):
        super(SegmentNet, self).__int__()
        ...
        self.layer4 = nn.Sequential(
                            nn.Conv2d(64, 1024, 5, stride=1, padding=2),
                            nn.BatchNorm2d(1024),
                            nn.ReLU(inplace=True)
                        )
...
class DecisionNet(nn.Module):
    def __int__(self, init_weights=True):
        super(DecisionNet, self).__int__()
