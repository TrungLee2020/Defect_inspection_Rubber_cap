...
def main(args):
    ...
    # load data as generators that yield batchs of preprocessed images
    ...
    # find best learning rate for training
    ...
    if args.inspect:
        ...
        logger.info("recontructing validation images...")
        ...
        tensor_val.genertor_inspection_plots(
        ...
        tensor_test.genertor_inspection_plots(
...
if __name__ == "__main__":
    ...
    if tf.test.is_gpu_available():
        ...
        logger.info("No GPU was detected. CNNs can be very low without a GPU...")
